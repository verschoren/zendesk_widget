$('document').ready(function() {
  ...
  $('main').before(`
    <div id="menu" class="hidden relative z-50 md:hidden font-brand" role="dialog" aria-modal="true">
      <div id="menu_background" class="fixed inset-0 bg-gray-900/80"></div>
  
      <div id="menu_sidebar" class="bg-white fixed inset-0 flex">
              ...
              <img class="hidden dark:block h-8 w-auto" src="https://demo.internalnote.com/img/logo_dark.svg" alt="Internal Note">
                ...
                <div class="rounded-md bg-lime p-4">
                  <div class="flex">
                    ...
                    <div class="ml-3">
                      <h3 class="text-sm font-medium text-licorice">Caching</h3>
                      <div class="mt-2 text-sm text-licorice">
  ...
  var links = [
    {
      ...
      "links": [
        ...
        { icon: '🎨', id: 'customlauncher', name: 'Custom Launcher', url: 'customlauncher.html' , title:'Custom Launcher for Messaging', description: 'Demo page to showcase the Custom Launcher for Zendesk Messaging'},
    ...
    },
    {
      ...
      { icon: '🎨', id: 'configurator', name: 'Configurator', url: 'https://widget.internalnote.com', title:'Zendesk Classic Widget Configurator', description: 'Demo page to showcase the Customization for the Classic Zendesk Widget'},
      ]
    },
    { 
      "type": "proactive",
  ...
  $.each(links, function(index,value) {
    var list_mobile = `
    <li>
      <div class="list_header text-sm font-semibold leading-6 text-licorice flex justify-between items-center" data-target="mobile_nav_ul_${value.type}">
        ${value.name}
    ...
    $.each(value.links, function(index,link){
      ...
      $('#desktop_nav_ul_'+value.type).append(`
        <li>
            <a href="https://demo.internalnote.com/${link.url}" class="${link.id} text-licorice dark:text-white hover:text-licorice hover:bg-transparant group flex gap-x-2 rounded-md p-2 text-sm leading-6">
