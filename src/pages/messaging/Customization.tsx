        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div>
            <section>
              <div className="flex justify-between items-center mb-2">
                ...
                <button
                  ...
                  type="button"
                  className="inline-flex items-center justify-center rounded-md border bg-matcha px-4 py-2 text-sm text-licorice hover:bg-blue-50"
                >
                  Copy Code
                </button>
              </div>
            ...
            <section className="mt-4">
              <nav className="isolate flex divide-x divide-gray-200 rounded-lg bg-white border-gray-200 border-1">
              ...
              <form id="theme-form" className="grid gap-3" onSubmit={(e) => e.preventDefault()}>
                <div className="grid grid-cols-4 gap-2">
                  ...
                  <button
                    ...
                    className="inline-flex items-center justify-center rounded-md border border-purple-600 bg-white px-4 py-2 text-sm font-medium text-purple-600 hover:bg-purple-50"
                    type="button"
                  >
                    Random Theme
                  </button>
